...
var JsonColeccionGrupos = /** @class */ (function (_super) {
    ...
    JsonColeccionGrupos.prototype.deleteGrupo = function (id) {
        for (var i = 0; i < this.getGrupos().length; i++) {
     ...
     * @param idUsuario
     */
    JsonColeccionGrupos.prototype.unirseGrupo = function (idGrupo, idUsuario) {
        _super.prototype.unirseGrupo.call(this, idGrupo, idUsuario);
        this.storeGroups();
    };
    /**
     ...
     * @param idUsuario
     */
    JsonColeccionGrupos.prototype.salirGrupo = function (idGrupo, idUsuario) {
        _super.prototype.salirGrupo.call(this, idGrupo, idUsuario);
        this.storeGroups();
    };
    /**
