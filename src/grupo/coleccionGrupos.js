...
var ColeccionGrupos = /** @class */ (function () {
    ...
    ColeccionGrupos.prototype.getGrupo = function (id) {
        var grupo = ColeccionGrupos.grupos.find(function (grupo) { return grupo.GetId() === id; });
        return grupo;
    };
    /**
     ...
     * @param idGrupo
     */
    ColeccionGrupos.prototype.unirseGrupo = function (idGrupo, id) {
        var grupo = ColeccionGrupos.grupos.find(function (grupo) { return grupo.GetId() === idGrupo; });
        if (grupo) {
     ...
     * @param idGrupo
     */
    ColeccionGrupos.prototype.salirGrupo = function (idGrupo, id) {
        var grupo = ColeccionGrupos.grupos.find(function (grupo) { return grupo.GetId() === idGrupo; });
        if (grupo) {
            grupo.salirGrupo(id);
        }
