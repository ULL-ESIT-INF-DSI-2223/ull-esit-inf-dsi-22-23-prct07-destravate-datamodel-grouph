...
var JsonColeccionUsuarios = /** @class */ (function (_super) {
     ...
     * @returns void
     */
    JsonColeccionUsuarios.prototype.deleteUsuario = function (idUsuario) {
     ...
     * @returns void
     */
    JsonColeccionUsuarios.prototype.aniadirAmigo = function (id, idAmigo) {
        _super.prototype.aniadirAmigo.call(this, id, idAmigo);
        this.storeUsers();
    };
    /**
     ...
     * @returns void
     */
    JsonColeccionUsuarios.prototype.eliminarAmigo = function (id, idAmigo) {
        _super.prototype.eliminarAmigo.call(this, id, idAmigo);
        this.storeUsers();
    };
    /**
