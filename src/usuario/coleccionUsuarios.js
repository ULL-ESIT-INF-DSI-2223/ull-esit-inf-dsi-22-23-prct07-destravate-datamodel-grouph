...
var ColeccionUsuarios = /** @class */ (function () {
    ...
    */
     ...
     * @param idAmigo
     */
    ColeccionUsuarios.prototype.aniadirAmigo = function (id, idAmigo) {
        var usuario = ColeccionUsuarios.usuarios.find(function (usuario) { return usuario.GetId() === id; });
        var amigo = ColeccionUsuarios.usuarios.find(function (usuario) { return usuario.GetId() === idAmigo; });
        if (usuario && amigo) {
     ...
     * @param idAmigo
     */
    ColeccionUsuarios.prototype.eliminarAmigo = function (id, idAmigo) {
        var usuario = ColeccionUsuarios.usuarios.find(function (usuario) { return usuario.GetId() === id; });
        var amigo = ColeccionUsuarios.usuarios.find(function (usuario) { return usuario.GetId() === idAmigo; });
        if (usuario && amigo) {
